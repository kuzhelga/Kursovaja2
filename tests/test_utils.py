...
from utils import get_data, get_filtered_data, get_data_with_from, get_five_last_values, get_formated_data
...
def test_get_formated_data(test_data):
    data = get_data_with_from(test_data)
    assert type(get_formated_data(data)) == list
